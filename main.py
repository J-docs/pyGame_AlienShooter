...
def final_text():
    ...
    screen.blit(my_final_font, (320, 200))
...
def there_is_a_collection(x_1, y_1, x_2, y_2):
...
while is_running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYUP:
            ...
            # Release Left and Right arrow key
            if event.key == pygame.K_LEFT or event.key == pygame.K_RIGHT:
                player_x_change = 0

            # Release Up and Down arrow key
    ...
    for enem in range(number_of_enemies):
        # end of game
        if enemy_y[enem] > 400 or enemy_y[enem] > player_y:
        ...
        # Collision
        collision = there_is_a_collection(enemy_x[enem], enemy_y[enem], bullet_x, bullet_y)
        if collision:
